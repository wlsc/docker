...
```
docker run -p 8080:8080 -p 50000:50000 wlsc/jenkins
```
...
```
docker run -p 8080:8080 -p 50000:50000 -v jenkins_home:/var/jenkins_home wlsc/jenkins
```
...
```
docker run --name myjenkins -p 8080:8080 -p 50000:50000 --env JAVA_OPTS=-Dhudson.footerURL=http://mycompany.com wlsc/jenkins
```
...
EOF
docker run --name myjenkins -p 8080:8080 -p 50000:50000 --env JAVA_OPTS="-Djava.util.logging.config.file=/var/jenkins_home/log.properties" -v `pwd`/data:/var/jenkins_home wlsc/jenkins
```
...
```
docker run --name myjenkins -p 8080:8080 -p 50001:50001 --env JENKINS_SLAVE_AGENT_PORT=50001 wlsc/jenkins
```
